...
namespace HeistPartII
{
    ...
    public class Muscle : IRobber
    {
        ...
        public void PerformSkill(Bank bank)
        {
            ...
            int StrongArm = bank.AlarmScore - SkillLevel;
            ...
            Console.WriteLine($"{Name} is taking car of the guards. Decreased security by {SkillLevel}.");
            ...
            if ( StrongArm <= 0)
            {
                Console.WriteLine($"{Name} disposed of the guards!");
            }
        }
    }
}