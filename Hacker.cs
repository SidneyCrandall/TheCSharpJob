...
namespace HeistPartII
{
    ...
    We'll need hackers to take care of the alarms; lock pick specialists to crack the vaults, and some good old fashion muscle to handle the security guards. 
    ...
    public class Hacker : IRobber
    {
        ...
        public void PerformSkill(Bank bank)
        {
            ...
            int HackerRank = bank.AlarmScore - SkillLevel;
            ...
            Console.WriteLine($"{Name} IServiceProvider hacking the alarm system. Decreased security by {SkillLevel}.");
            ...
            if ( HackerRank <= 0)
            {
                Console.WriteLine($"{Name} disabled the alerm system!");
            }
        }
    }
}